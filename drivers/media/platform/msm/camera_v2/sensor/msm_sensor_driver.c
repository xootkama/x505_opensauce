	...
	pr_err("%s slave_info->sensor_name =%s\n",__func__, slave_info->sensor_name);//slave_info is from userspace
		for(i=0; i<CAMERA_VENDOR_EEPROM_COUNT_MAX; i++){
			...
			if(strcmp(slave_info->eeprom_name,s_vendor_eeprom[i].eeprom_name) == 0){
				if(((strcmp(slave_info->sensor_name,"lenovo_s5k4h7_ofilm_i") == 0) && (s_vendor_eeprom[i].module_id == MID_OFILM))
					|| ((strcmp(slave_info->sensor_name,"lenovo_s5k4h7_qtech_i") == 0) && (s_vendor_eeprom[i].module_id == MID_QTECH))
					|| ((strcmp(slave_info->sensor_name,"lenovo_s5kc505a_ofilm_front_i") == 0) && (s_vendor_eeprom[i].module_id == MID_OFILM))
					|| ((strcmp(slave_info->sensor_name,"lenovo_s5kc505a_qtech_front_ii") == 0) && (s_vendor_eeprom[i].module_id == MID_QTECH))
					|| (strcmp(slave_info->sensor_name,"lenovo_s5k4e8_ofilm_front_i") == 0)
				){
	...
	pr_err("%s slave_info->sensor_name =%s\n",__func__, slave_info->sensor_name);//slave_info is from userspace
		for(i=0; i<CAMERA_VENDOR_EEPROM_COUNT_MAX; i++){
			...
			if(strcmp(slave_info->eeprom_name,s_vendor_eeprom[i].eeprom_name) == 0){
				...
				if(((strcmp(slave_info->sensor_name,"lenovo_hi556_lcetron_back_i") == 0) && (s_vendor_eeprom[i].module_id == VID_ZERO))
					|| ((strcmp(slave_info->sensor_name,"lenovo_hi556_lcetron_anatech") == 0) && (s_vendor_eeprom[i].module_id == VID_ONE))
					|| ((strcmp(slave_info->sensor_name,"lenovo_s5k4h7_ofilm_i_p400") == 0))
					|| ((strcmp(slave_info->sensor_name,"lenovo_gc5025a_holitech_back_i") == 0))
					|| (strcmp(slave_info->sensor_name,"lenovo_sp2509h_lcetron_front_i") == 0)
					|| (strcmp(slave_info->sensor_name,"lenovo_gc2375h_ui_front_ii") == 0)
				){
					pr_err("module found!probe continue!eeprom_name=%s\n", slave_info->eeprom_name);
					break;
				}
